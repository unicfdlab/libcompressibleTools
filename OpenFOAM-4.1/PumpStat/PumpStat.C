...
Foam::tmp<Foam::scalarField> Foam::functionObjects::PumpStat::normalStress(const word& patchName) const
{
...
void Foam::functionObjects::PumpStat::read(const dictionary& dict)
{
    if (!active())
    {
	return;
...
Foam::scalar Foam::functionObjects::PumpStat::patchesArea(const List<word>& patches)
{
    const fvMesh& mesh = refCast<const fvMesh>(obr_);
    scalar area = 0.0;
...
Foam::scalar Foam::functionObjects::PumpStat::patchFlow(const word& phiName, const List<word>& patches)
{
    const fvMesh& mesh = refCast<const fvMesh>(obr_);
...
Foam::scalar Foam::functionObjects::PumpStat::volPatchIntegrate(const word& fieldName, const List<word>& patches)
{
    const fvMesh& mesh = refCast<const fvMesh>(obr_);
...
Foam::vector Foam::functionObjects::PumpStat::gatherMoments()
{
    const fvMesh& mesh = refCast<const fvMesh>(obr_);
...
void Foam::functionObjects::PumpStat::writeFft()
{
...
bool Foam::functionObjects::PumpStat::end()
{
    return true;
}
...
void Foam::functionObjects::PumpStat::timeSet()
{
}
